    ...
    while cap.isOpened():
        ...
        if results.multi_hand_landmarks:
            ...
            for hand_landmarks in results.multi_hand_landmarks:
                ...
                target = Point(hand_landmarks.landmark[4].x,hand_landmarks.landmark[4].y)
                if target.within(palmPoly):
                    thumbIsOpen = False
                target = Point(hand_landmarks.landmark[8].x,hand_landmarks.landmark[8].y)
                if target.within(palmPoly):
                    firstFingerIsOpen = False
                target = Point(hand_landmarks.landmark[12].x,hand_landmarks.landmark[12].y)
                if target.within(palmPoly):
                    secondFingerIsOpen = False
                target = Point(hand_landmarks.landmark[16].x,hand_landmarks.landmark[16].y)
                if target.within(palmPoly):
                    thirdFingerIsOpen = False
                target = Point(hand_landmarks.landmark[20].x,hand_landmarks.landmark[20].y)
                if target.within(palmPoly):
                ...
                not thirdFingerIsOpen) and (not fourthFingerIsOpen):
                    word = "ONE"
